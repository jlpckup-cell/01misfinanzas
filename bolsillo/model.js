...
export function initialPlan(m){return {...m,budgetShares:Object.fromEntries(categories.map(c=>[c.id,c.share])),budgets:allocate(m.opening),planVersion:2};}
